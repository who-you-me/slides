...
- 問題点が可視化され、改善のプロセスを回すことができるようになった
    - 「この人こんなこと思ってたんだ！」と参考になることもよくある
- 定期的に開催することで、課題が放置されないのは大きな利点
...
- できたこと
    - 優先度順に並べることで、非エンジニアとの共通言語化
    - デイリースクラム、PivotalTrackerの導入により進捗を把握
    - デイリースクラムやふりかえりで問題点を可視化し改善のプロセスが回る
- まだ残っている課題
    - 仕様の詳細について食い違うことが多い
    - スプリント単位で開発していない
    - 人が足りない
